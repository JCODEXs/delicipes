...
const MealMatrix = () => {
  ...
  // Calculate totals when selectedRecipes or portions change
  useEffect(() => {
  ...
  // Reset picker selection when modal closes
  useEffect(() => {
    if (showRecipePicker) {
      setPickerSelected([]);
    }
  ...
  // Your other functions remain the same (calculateTotals, handleSelectRecipe, etc.)
